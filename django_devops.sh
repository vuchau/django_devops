...
django_source() {
	...
	if [ "_$DJANGO_METHOD" = "_script" ]; then
		DJANGO_SOURCE="https://raw.githubusercontent.com/thuongdinh/django_devops/v0.1.0/django_devops.sh"
	elif [ "_$DJANGO_METHOD" = "_script-ddevops-exec" ]; then
		DJANGO_SOURCE="https://raw.githubusercontent.com/thuongdinh/django_devops/v0.1.0/django_devops-exec"
